...
export const mockResources = [
  ...
  { id: 'res-1', name: 'Alice Johnson', position: 'Frontend Developer', avatar: 'https://i.pravatar.cc/150?img=1' },
  { id: 'res-2', name: 'Bob Smith', position:'Backend Developer', avatar: 'https://i.pravatar.cc/150?img=2' },
  { id: 'res-3', name: 'Carol Davis', position:'Product Owner', avatar: 'https://i.pravatar.cc/150?img=3' },
  { id: 'res-4', name: 'David Lee', position:'Full Stack Developer', avatar: 'https://i.pravatar.cc/150?img=4' },
  { id: 'res-5', name: 'Emma Wilson', position:'UI/UX Designer', avatar: 'https://i.pravatar.cc/150?img=5' },
  { id: 'res-6', name: 'Frank Martinez', position:'Backend Developer', avatar: 'https://i.pravatar.cc/150?img=6' },
  { id: 'res-7', name: 'Grace Chen', position:'Frontend Developer', avatar: 'https://i.pravatar.cc/150?img=7' },
  { id: 'res-8', name: 'Henry Taylor', position:'QA Engineer', avatar: 'https://i.pravatar.cc/150?img=8' },

  // Engineering Team (10 members)
  { id: 'res-9', name: 'Isabella Garcia', position:'Senior Backend Developer', avatar: 'https://i.pravatar.cc/150?img=9' },
  { id: 'res-10', name: 'Jack Robinson', position:'Frontend Developer', avatar: 'https://i.pravatar.cc/150?img=10' },
  { id: 'res-11', name: 'Katherine Moore', position:'Full Stack Developer', avatar: 'https://i.pravatar.cc/150?img=11' },
  { id: 'res-12', name: 'Liam Anderson', position:'Backend Developer', avatar: 'https://i.pravatar.cc/150?img=12' },
  { id: 'res-13', name: 'Maya Thompson', position:'Frontend Developer', avatar: 'https://i.pravatar.cc/150?img=13' },
  { id: 'res-14', name: 'Noah White', position:'Senior Full Stack Developer', avatar: 'https://i.pravatar.cc/150?img=14' },
  { id: 'res-15', name: 'Olivia Harris', position:'Backend Developer', avatar: 'https://i.pravatar.cc/150?img=15' },
  { id: 'res-16', name: 'Peter Clark', position:'Frontend Developer', avatar: 'https://i.pravatar.cc/150?img=16' },
  { id: 'res-17', name: 'Quinn Lewis', position:'Full Stack Developer', avatar: 'https://i.pravatar.cc/150?img=17' },
  { id: 'res-18', name: 'Rachel Walker', position:'QA Engineer', avatar: 'https://i.pravatar.cc/150?img=18' },

  // Design Team (5 members)
  { id: 'res-19', name: 'Samuel Hall', position:'UI/UX Designer', avatar: 'https://i.pravatar.cc/150?img=19' },
  { id: 'res-20', name: 'Tina Young', position:'UI/UX Designer', avatar: 'https://i.pravatar.cc/150?img=20' },
  { id: 'res-21', name: 'Uma Patel', position:'Senior UI/UX Designer', avatar: 'https://i.pravatar.cc/150?img=21' },
  { id: 'res-22', name: 'Victor King', position:'Graphic Designer', avatar: 'https://i.pravatar.cc/150?img=22' },
  { id: 'res-23', name: 'Wendy Scott', position:'Product Designer', avatar: 'https://i.pravatar.cc/150?img=23' },

  // Infrastructure Team (6 members)
  { id: 'res-24', name: 'Xavier Green', position:'DevOps Engineer', avatar: 'https://i.pravatar.cc/150?img=24' },
  { id: 'res-25', name: 'Yolanda Baker', position:'Cloud Engineer', avatar: 'https://i.pravatar.cc/150?img=25' },
  { id: 'res-26', name: 'Zachary Adams', position:'DevOps Engineer', avatar: 'https://i.pravatar.cc/150?img=26' },
  { id: 'res-27', name: 'Aria Nelson', position:'Site Reliability Engineer', avatar: 'https://i.pravatar.cc/150?img=27' },
  { id: 'res-28', name: 'Blake Carter', position:'Cloud Architect', avatar: 'https://i.pravatar.cc/150?img=28' },
  { id: 'res-29', name: 'Chloe Mitchell', position:'DevOps Engineer', avatar: 'https://i.pravatar.cc/150?img=29' },

  // Data Team (6 members)
  { id: 'res-30', name: 'Dylan Perez', position:'Data Engineer', avatar: 'https://i.pravatar.cc/150?img=30' },
  { id: 'res-31', name: 'Elena Roberts', position:'Data Analyst', avatar: 'https://i.pravatar.cc/150?img=31' },
  { id: 'res-32', name: 'Felix Turner', position:'ML Engineer', avatar: 'https://i.pravatar.cc/150?img=32' },
  { id: 'res-33', name: 'Gabriella Phillips', position:'Data Scientist', avatar: 'https://i.pravatar.cc/150?img=33' },
  { id: 'res-34', name: 'Hudson Campbell', position:'Senior Data Engineer', avatar: 'https://i.pravatar.cc/150?img=34' },
  { id: 'res-35', name: 'Iris Parker', position:'Data Analyst', avatar: 'https://i.pravatar.cc/150?img=35' },
];
