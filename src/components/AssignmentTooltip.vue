<template>
  <div v-if="visible" class="assignment-tooltip" :style="tooltipStyle">
    <div class="tooltip-title">{{ data.project?.name }}</div>
    <div class="tooltip-row">
      <span class="tooltip-label">Capacity:</span>
      <span class="tooltip-value">{{ data.capacity_percentage }}%</span>
    </div>
    <div class="tooltip-row">
